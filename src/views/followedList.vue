            ...
            <h1 class="title">粉丝列表</h1>
             ...
             <ul class="follows-list">
                <li v-for="item in fans" :key="item.id" class="follows-item"> 
                    ...
                    <!-- item.followed=false的时候有class，且可用 -->
                    <!-- item.followed=true的时候无class，且不可用 -->
                    <el-button :class="{ 'follow-btn': !item.followed }" @click="handleFollow(item)"
